...
import { get_Goods_action2 } from '../../../../action/actioncreator'

class GoodsTwo extends Component {
    render() {
...
const mapDispatchToProps = (dispatch) => ({
    getGoodsData() {
        get_Goods_action2(dispatch)
    }
})

export default connect(mapStateToProps, mapDispatchToProps)(GoodsTwo);